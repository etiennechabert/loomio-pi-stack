...
0 * * * * /app/backup-hourly.sh >> /proc/1/fd/1 2>&1

# Daily backups at 2 AM (30d retention)
0 2 * * * /app/backup-daily.sh >> /proc/1/fd/1 2>&1
...
echo "  - Hourly:  0 * * * * (every hour)"
echo "  - Daily:   0 2 * * * (2 AM)"
echo "  - Monthly: 0 3 1 * * (1st of month at 3 AM)"
echo ""
